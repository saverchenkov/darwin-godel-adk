...
The current execution ID is: {execution_id}. When you generate content for 'knowledge.md', you MUST use this exact ID value where appropriate, for example in headers like '## Execution Analysis - {execution_id}'. DO NOT generate the placeholder '{{{{ execution_id }}}}'.
